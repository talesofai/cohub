...
LOCAL_RUNTIME_ENABLED=$(get_value "LOCAL_RUNTIME_ENABLED")
LOCAL_RUNTIME_PI_ENABLED=$(get_value "LOCAL_RUNTIME_PI_ENABLED")
LOCAL_RUNTIME_CLAUDE_ENABLED=$(get_value "LOCAL_RUNTIME_CLAUDE_ENABLED")
LOCAL_RUNTIME_CODEX_ENABLED=$(get_value "LOCAL_RUNTIME_CODEX_ENABLED")
...
PY
  ...
  sed -i.bak \
    ...
    -e "s|__LOCAL_RUNTIME_ENABLED__|${LOCAL_RUNTIME_ENABLED}|g" \
    -e "s|__LOCAL_RUNTIME_PI_ENABLED__|${LOCAL_RUNTIME_PI_ENABLED}|g" \
    -e "s|__LOCAL_RUNTIME_CLAUDE_ENABLED__|${LOCAL_RUNTIME_CLAUDE_ENABLED}|g" \
    -e "s|__LOCAL_RUNTIME_CODEX_ENABLED__|${LOCAL_RUNTIME_CODEX_ENABLED}|g" \
    "$dst"
  rm -f "$dst.bak"
}
