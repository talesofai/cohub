...
API_LOCK_DB_POOL_MAX=$(get_value "API_LOCK_DB_POOL_MAX")
WORKSPACE_REPLICATION_ENABLED=$(get_value "WORKSPACE_REPLICATION_ENABLED")
NATIVE_AGENT_MIRROR_ENABLED=$(get_value "NATIVE_AGENT_MIRROR_ENABLED")
NATIVE_AGENT_PI_ENABLED=$(get_value "NATIVE_AGENT_PI_ENABLED")
NATIVE_AGENT_CLAUDE_ENABLED=$(get_value "NATIVE_AGENT_CLAUDE_ENABLED")
NATIVE_AGENT_CODEX_ENABLED=$(get_value "NATIVE_AGENT_CODEX_ENABLED")
LOCAL_ACP_RUNTIME_ENABLED=$(get_value "LOCAL_ACP_RUNTIME_ENABLED")
LOCAL_ACP_PI_ENABLED=$(get_value "LOCAL_ACP_PI_ENABLED")
LOCAL_ACP_CLAUDE_ENABLED=$(get_value "LOCAL_ACP_CLAUDE_ENABLED")
LOCAL_ACP_CODEX_ENABLED=$(get_value "LOCAL_ACP_CODEX_ENABLED")
...
PY
  ...
  sed -i.bak \
    ...
    -e "s|__WORKSPACE_OBJECT_ENDPOINT__|${WORKSPACE_OBJECT_ENDPOINT}|g" \
    -e "s|__WORKSPACE_OBJECT_REGION__|${WORKSPACE_OBJECT_REGION}|g" \
    -e "s|__WORKSPACE_OBJECT_BUCKET__|${WORKSPACE_OBJECT_BUCKET}|g" \
    ...
    -e "s|__API_LOCK_DB_POOL_MAX__|${API_LOCK_DB_POOL_MAX:-8}|g" \
    -e "s|__WORKSPACE_REPLICATION_ENABLED__|${WORKSPACE_REPLICATION_ENABLED}|g" \
    -e "s|__NATIVE_AGENT_MIRROR_ENABLED__|${NATIVE_AGENT_MIRROR_ENABLED}|g" \
    -e "s|__NATIVE_AGENT_PI_ENABLED__|${NATIVE_AGENT_PI_ENABLED}|g" \
    -e "s|__NATIVE_AGENT_CLAUDE_ENABLED__|${NATIVE_AGENT_CLAUDE_ENABLED}|g" \
    -e "s|__NATIVE_AGENT_CODEX_ENABLED__|${NATIVE_AGENT_CODEX_ENABLED}|g" \
    -e "s|__LOCAL_ACP_RUNTIME_ENABLED__|${LOCAL_ACP_RUNTIME_ENABLED}|g" \
    -e "s|__LOCAL_ACP_PI_ENABLED__|${LOCAL_ACP_PI_ENABLED}|g" \
    -e "s|__LOCAL_ACP_CLAUDE_ENABLED__|${LOCAL_ACP_CLAUDE_ENABLED}|g" \
    -e "s|__LOCAL_ACP_CODEX_ENABLED__|${LOCAL_ACP_CODEX_ENABLED}|g" \
    "$dst"
  rm -f "$dst.bak"
}
