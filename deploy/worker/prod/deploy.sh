...
WORKER_LOCK_DB_POOL_MAX=$(get_value "WORKER_LOCK_DB_POOL_MAX")
WORKSPACE_SYNC_WORKER_CONCURRENCY=$(get_value "WORKSPACE_SYNC_WORKER_CONCURRENCY")
...
PY
  ...
  sed -i.bak \
    ...
    -e "s|__WORKER_LOCK_DB_POOL_MAX__|${WORKER_LOCK_DB_POOL_MAX:-6}|g" \
    -e "s|__WORKSPACE_SYNC_WORKER_CONCURRENCY__|${WORKSPACE_SYNC_WORKER_CONCURRENCY}|g" \
